                                    ...
                                    <div class="flex flex-wrap gap-4 lg:gap-6 sm:py-2.5">
                                        <div class="sm:-my-2.5">
                                            <a href="/" class="group w-24 sm:w-40 h-40 sm:h-56 block bg-gray-100 rounded-lg overflow-hidden relative">
                                                <img src={product.img} loading="lazy" alt="" class="w-full h-full object-cover object-center group-hover:scale-110 transition duration-200" />
                                            </a>
                                        </div>

                                        <div class="flex flex-col justify-between flex-1">
                                            <div>
                                                <a href="/" class="inline-block text-gray-800 hover:text-gray-500 text-lg lg:text-2xl font-bold transition duration-100 mb-1">{product.name}</a>
                                                ...
                                                <span class="block text-gray-500 mb-2"><b>Description :</b> {product.description}</span>
                                            </div>

                                            <div>
                                                <span class="block text-gray-800 md:text-lg font-bold mb-1">$ <span>{product.price}</span> <span><small> /per product</small></span></span>
                                        ...
                                        <div class="w-full sm:w-auto border-t sm:border-none pt-4 sm:pt-0 lg:mt-8">
                                            <div class="pt-3 sm:pt-2 ml-4 md:ml-8 lg:ml-10 lg:mr-8 lg:mb-5">
                                                <span class="block text-gray-800 md:text-lg font-bold">Total stock {product.stock}</span>
                                            </div>
                                            <form action="">
