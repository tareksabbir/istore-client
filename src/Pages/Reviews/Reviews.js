                ...
                <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
                    ...
                    <div class="grid sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
                        ...
                        <div class="flex flex-col border rounded-lg gap-3 p-4 md:p-6">
                            ...
                            <p class="text-gray-600">Apple authentic products with best customer services. phone is great but, very limited use with contracted service provider. Little more than a paperweight currently.</p>
                        </div>
                        ...
                        <div class="flex flex-col border rounded-lg gap-3 p-4 md:p-6">
                            ...
                            <p class="text-gray-600">I honestly have been trying to fix my iPhone for well over a year. I accidentally came across the iStore support app to download to my phone it was the best thing that ever happened!.</p>
                        </div>
                        ...
                        <div class="flex flex-col border rounded-lg gap-3 p-4 md:p-6">
                            ...
                            <p class="text-gray-600">Very helpful and support is top notch! I had a replacement iPad sent and I returned it because I thought the port was blocked. I realized after I sent it that the cord was switched out by someone in the house.</p>
                        </div>
