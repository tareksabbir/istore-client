    ...
    return (
        <header className="flex justify-between items-center py-8 md:py-8  max-w-screen-2xl px-4 md:px-10 mx-auto">
            ...
            <nav className="hidden lg:flex gap-12">
                ...
                <Link to='/bigallery' className="text-gray-500 hover:text-black active:text-indigo-700 text-lg font-semibold transition duration-100">Gallery</Link>

                <Link to='/pricing' className="text-gray-500 hover:text-black active:text-indigo-700 text-lg font-semibold transition duration-100">Pricing</Link>
            ...
            <Link to='/pricing' className="hidden lg:inline-block bg-black hover:bg-gray-600 focus-visible:ring ring-indigo-300 text-white active:text-gray-700 text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-8 py-3">Contact Us</Link>
