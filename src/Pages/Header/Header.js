...
const Header = () => {
    return (
        <>
            <div class="bg-white pb-6 sm:pb-8 lg:pb-12 lg:mt-10">
                <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">


                    <section class="flex flex-col lg:flex-row justify-between gap-6 sm:gap-10 md:gap-16">

                        <div class="xl:w-5/12 flex flex-col justify-between lg:ml-10">
                            <div></div>

                            <div class="sm:text-center lg:text-left lg:py-12 xl:py-24">
                                <p class=" text-gray-500 md:text-lg xl:text-xl font-semibold mb-4 md:mb-6">Very proud to introduce</p>
                        ...
                        <div class="xl:w-5/12 h-48 lg:h-auto bg-gray-100 overflow-hidden shadow-lg rounded-lg lg:mr-10">
                            <img src="https://images.unsplash.com/photo-1491933382434-500287f9b54b?auto=format&q=75&fit=crop&w=1000&h=600" loading="lazy" alt="" class="w-full h-full object-cover object-center" />
                        </div>
